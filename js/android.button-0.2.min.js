$(function()
{
    function generateRGBAColor(couleurToBeConverted){
		var alpha = couleurToBeConverted.substr(0, 2);
		alpha = (parseInt(alpha, 16) / 255.0).toFixed(2);
		
		var redColor = couleurToBeConverted.substr(2, 2);
		redColor = parseInt(redColor, 16);
		
		var greenColor = couleurToBeConverted.substr(4, 2);
		greenColor = parseInt(greenColor, 16);
		
		var blueColor = couleurToBeConverted.substr(6, 2);
    ...
    function d()
    {
        ...
        $("#preview").css({
            color:generateRGBAColor(b.btn_textcolor)
        });
        
		b.isshadow?$("#preview").css({
            "text-shadow":b.btn_shadowdx+"px "+b.btn_shadowdy+"px "+b.btn_shadowradius+"px "+ generateRGBAColor(b.btn_shadowcolor)
        }):$("#preview").css({
            "text-shadow":"none"
        });
        f()
    ...
    function c(b)
    {
        ...
        /corners_/.test(b)?!0==a.isradius?($("#preview").css({
            ...
            background:" linear-gradient("+deg+"deg, "+generateRGBAColor(a.gradient_startcolor)+" 0%, "+generateRGBAColor(a.gradient_centercolor)+" "+a.gradient_centerx+"%, "+generateRGBAColor(a.gradient_endcolor)+" 100%)"
        }):$("#preview").css({
            background:" linear-gradient("+deg+"deg, "+generateRGBAColor(a.gradient_startcolor)+" 0%, "+generateRGBAColor(a.gradient_endcolor)+" 100%)"
        })):"radial"==type&&(a.iscenter?(midcolpos=a.gradient_gradientradius/2
        ,k="radial-gradient(circle farthest-corner at "+a.gradient_centerx+"% "+a.gradient_centery+"%, "+generateRGBAColor(a.gradient_startcolor)+" 0px, "+generateRGBAColor(a.gradient_centercolor)+" "+midcolpos+"px, "+generateRGBAColor(a.gradient_endcolor)+" "+a.gradient_gradientradius+"px) repeat scroll 0 0 transparent"):k="radial-gradient(circle farthest-corner at "+a.gradient_centerx+"% "+a.gradient_centery+"%, "+generateRGBAColor(a.gradient_startcolor)+" 0px, "+generateRGBAColor(a.gradient_endcolor)+" "+a.gradient_gradientradius+"px) repeat scroll 0 0 transparent",$("#preview").css({
            background:k
        }))):$("#preview").css({
            background:generateRGBAColor(a.solid_color)
        }):h.test(b)?$("#preview").css({
            "background-color":generateRGBAColor(a.solid_color)
		...
		$("#preview").css({
            ...
            border:a.stroke_width+"px solid "+generateRGBAColor(a.stroke_color)
        });
        f()
    }
    function f()
    {
        shadow_code="";
        b.isshadow&&(shadow_code='<div> <span class="r">android:shadowColor</span>=<span class="b">"#'+b.btn_shadowcolor+'"</span> </div> <div> <span class="r">android:shadowDx</span>=<span class="b">"'+b.btn_shadowdx+'dp"</span> </div> <div> <span class="r">android:shadowDy</span>=<span class="b">"'+b.btn_shadowdy+'dp"</span> </div> <div> <span class="r">android:shadowRadius</span>=<span class="b">"'+b.btn_shadowradius+'dp"</span> </div> ');
        btn_code='<span class="g">&lt;Button</span> <div class="code-shape"> <div> <span class="r">android:id</span>=<span class="b">"'+b.btn_id+'"</span> </div><div> <span class="r">android:text</span>=<span class="b">"'+b.btn_text+'"</span> </div> <div> <span class="r">android:textColor</span>=<span class="b">"#'+b.btn_textcolor+'"</span> </div> <div> <span class="r">android:textSize</span>=<span class="b">"'+b.btn_textsize+'sp"</span></div><div><span class="r">android:layout_width</span>=<span class="b">"'+ 
		<!--a.size_width -->
		'wrap_content'
		+'dp"</span> </div> <div><span class="r"> android:layout_height</span>=<span class="b">"'+
		<!-- a.size_height -->
		'wrap_content'
		+'dp"</span> </div><div> <span class="r">android:background</span>=<span class="b">"'+b.btn_background+'"</span> </div> '+shadow_code+' </div><span class="g">/&gt;</span>';
        corner_code="";
        corner_code=a.isradius?corner_code+('<div><div><span class="g">&lt;corners</span><div><span class="r">android:topLeftRadius</span>=<span class="b">"'+a.corners_topleftradius+'dp"</SPAN></div><div><span class="r">android:topRightRadius</SPAN>=<span class="b">"'+a.corners_toprightradius+'dp"</SPAN></div><div><span class="r">android:bottomLeftRadius</SPAN>=<span class="b">"'+a.corners_bottomleftradius+'dp"</SPAN></div><div><span class="r"> android:bottomRightRadius</SPAN>=<span class="b">"'+a.corners_bottomrightradius+'dp"</SPAN></div><span class="g">/&gt; </SPAN></div></div>'):corner_code+('<div><div><span class="g">&lt;corners</span> <div> <span class="r">android:radius</span>=<span class="b">"'+a.corners_radius+'dp"</span> </div> <span class="g">/&gt;</span> </div></div>');
    ...
    ,a=
    {
        ...
        ,gradient_centerx:"35"
        ,gradient_centery:"50"
        ,gradient_startcolor:"449DEF"
        ,gradient_centercolor:"198CFF"
        ,gradient_endcolor:"2F6699"
   ...
   <!-- }); -->
    ...
    "gradient"==a.bgtype? ("linear"==a.gradient_type?($(".typeradial").hide(),$(".typelineer").show(),$("#gradient_centerx").removeAttr("disabled"),$("div.centerx span.lbl").css({
        ...
        background:" linear-gradient("+deg+"deg, "+generateRGBAColor(a.gradient_startcolor)+" 0%, "+generateRGBAColor(a.gradient_centercolor)+" 50%, "+generateRGBAColor(a.gradient_endcolor)+" 100%)"
        ...
        color:"black"
    }),a.iscenter?(midcolpos=a.gradient_gradientradius/2
    ,k="radial-gradient(circle farthest-corner at "+a.gradient_centerx+"% "+a.gradient_centery+"%, "+generateRGBAColor(a.gradient_startcolor)+" 0px, "+generateRGBAColor(a.gradient_centercolor)+" "+midcolpos+"px, "+generateRGBAColor(a.gradient_endcolor)+" "+a.gradient_gradientradius+"px) repeat scroll 0 0 transparent",$("#preview").css({
        background:k
    }),$("div.centercol span.lbl").css({
        color:"black"
    }),$("#gradient_centercolor").removeAttr("disabled")):(k="radial-gradient(circle farthest-corner at "+a.gradient_centerx+"% "+a.gradient_centery+"%, "+generateRGBAColor(a.gradient_startcolor)+" 0px, "+generateRGBAColor(a.gradient_endcolor)+" "+a.gradient_gradientradius+"px) repeat scroll 0 0 transparent",$("#preview").css({
        background:k
    }),$("div.centercol span.lbl").css({
        color:"#888888"
    }),$("#gradient_centercolor").attr("disabled",!0)))):($("#preview").css({
        background:generateRGBAColor(a.solid_color)
    }));
